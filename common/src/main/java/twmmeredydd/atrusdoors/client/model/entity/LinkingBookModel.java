...
public class LinkingBookModel extends EntityModel<LinkingBookEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partDefinition.addOrReplaceChild("top_cover", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, 0.0F, -4.5F, 6.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(12, 0).addBox(0.0F, 0.005F, -4.5F, 6.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 21.99F, 0.0F));
    ...
    public void setupAnim(LinkingBookEntity entity, float f, float g, float h, float i, float j) {
        this.topCover.zRot = -f * 2 * Mth.PI * 170 / 360;
    }
